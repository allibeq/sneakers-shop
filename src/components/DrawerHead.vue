...
<template>
  <div class="flex items-center gap-4 mb-4">
    <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg" class="cursor-pointer opacity-50 rotate-180 hover:opacity-100 transition">
